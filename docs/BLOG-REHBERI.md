...
translationKey: benzersiz-anahtar   # yalnızca çevirisi varsa; iki dilde AYNI değer
draft: false                        # true → yazı siteye çıkmaz (taslak)
---
```

- `translationKey`: Aynı yazının TR ve EN versiyonlarını birbirine bağlar (Google'a
